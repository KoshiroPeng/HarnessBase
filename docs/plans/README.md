...
本目录沉淀 HarnessBase 当前文档与工程收敛计划，帮助协作者理解当前阶段目标、已完成验证、后续待办和自动化推进节奏。
...
| 第一阶段文档检查维护说明 | [docs/plans/phase1-doc-check-ci-brief.md](phase1-doc-check-ci-brief.md) |
...
- 如果要维护自动化检查或调整后续规则范围，读 [docs/plans/harness-automation-implementation-brief.md](harness-automation-implementation-brief.md)。
- 如果要维护第一阶段文档结构类检查，读 [docs/plans/phase1-doc-check-ci-brief.md](phase1-doc-check-ci-brief.md)。
- 如果要维护历史事实误用扫描提醒链路，读 [docs/plans/phase2-history-scan-brief.md](phase2-history-scan-brief.md)。
- 如果要维护 workflow 路径护栏阻断规则，读 [docs/plans/phase3-workflow-path-check-brief.md](phase3-workflow-path-check-brief.md)。
- 如果要维护 API、响应码、SQL 和发布材料提醒，读 [docs/plans/phase4-doc-sync-reminder-brief.md](phase4-doc-sync-reminder-brief.md)。
