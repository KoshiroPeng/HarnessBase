...
| 事项 | 当前状态 | 说明 |
| --- | --- | --- |
| 文档与 workflow 护栏脚本 | 已通过 | `python .github/scripts/doc_guardrails.py` 可通过，当前覆盖 A01/A02/A03/A05 |
...
- 自动化 A01-A03 与 A05 已接入 [.github/scripts/doc_guardrails.py](../../.github/scripts/doc_guardrails.py) 和 [.github/workflows/agent-guardrails.yml](../../.github/workflows/agent-guardrails.yml)，后续重点转为 A04 历史事实误用扫描和 A06-A08 同步提醒。
