...
- 自动化第一阶段 A01-A03 已接入 [.github/scripts/doc_guardrails.py](../../.github/scripts/doc_guardrails.py) 和 [.github/workflows/agent-guardrails.yml](../../.github/workflows/agent-guardrails.yml)，后续重点转为 A05 workflow 路径护栏、A04 历史事实误用扫描和 A06-A08 同步提醒。
