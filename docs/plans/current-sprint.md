...
| 事项 | 当前状态 | 说明 |
| --- | --- | --- |
| 文档与 workflow 护栏脚本 | 已通过 | `python .github/scripts/doc_guardrails.py` 可通过，当前覆盖 A01-A08，其中 A04、A06、A07、A08 为提醒模式 |
...
- 自动化 A01-A08 已接入 [.github/scripts/doc_guardrails.py](../../.github/scripts/doc_guardrails.py) 和 [.github/workflows/agent-guardrails.yml](../../.github/workflows/agent-guardrails.yml)，其中 A04、A06、A07、A08 以提醒模式运行。
