...
status: active
owner: "@PengKang"
description: HarnessBase 文档导航总入口，按当前微服务项目的开发、评审、测试、发布与治理场景组织材料。
---
...
本文档是 HarnessBase 的统一文档入口。当前仓库的真实代码主线是若依微服务后台管理系统，文档必须围绕现有 [server](../server)、[web](../web)、[deploy](../deploy) 和 [.github/workflows](../.github/workflows) 事实组织。
...
| 判断当前文档哪些稳定、哪些仍需纠偏 | [docs/plans/documentation-closure-status.md](plans/documentation-closure-status.md) |
