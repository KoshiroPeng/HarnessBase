...
- 新增检查项后，必须从 [docs/README.md](../README.md) 或 [docs/conventions/README.md](README.md) 能直接进入。
...
| A06 | API 文档同步提醒 | 提醒 | 已接入当前文档护栏脚本 |
| A07 | 错误码与异常文档同步提醒 | 提醒 | 已接入当前文档护栏脚本 |
| A08 | SQL 与发布材料同步提醒 | 提醒 | 已接入当前文档护栏脚本 |
...
4. 已完成 `A06`、`A07`、`A08`，并以提醒模式运行，后续只维护触发范围和提示文案。

## 维护规则

- 如果阻断级别发生变化，先更新本文档，再调整 CI。
- 如果新增忽略规则，必须写明原因。
- 如果新增、删除或调整某项检查，必须同步更新本文档、[.github/scripts/doc_guardrails.py](../../.github/scripts/doc_guardrails.py) 和相关 workflow 入口。
