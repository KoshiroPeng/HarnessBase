...
如果下一步要把这些规范接成自动检查或 CI 提醒，优先联读 [docs/conventions/harness-automation-roadmap.md](harness-automation-roadmap.md) 和 [docs/plans/harness-automation-implementation-brief.md](../plans/harness-automation-implementation-brief.md)。
