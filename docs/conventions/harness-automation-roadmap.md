...
1. 维护并持续验证 A01-A03 文档护栏和 A05 workflow 路径护栏。
2. 优先补 A04 历史事实误用扫描，先以提醒模式运行。
3. 最后补 A06-A08 API、响应码、SQL、发布材料的同步提醒。
...
该命令当前应输出 A01/A02/A03/A05 通过。若失败，先修复元数据、相对链接、锚点或 workflow 路径，再继续做后端、前端或发布相关验证。
