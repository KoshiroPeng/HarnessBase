...
- 自动化检查试运行、阶段验收或阻断策略评估时，优先联读 [docs/plans/automation-delivery-map.md](../plans/automation-delivery-map.md) 与 [docs/reviews/templates/automation-pilot-verification-template.md](templates/automation-pilot-verification-template.md)。
...
| 自动化试运行验证模板 | [docs/reviews/templates/automation-pilot-verification-template.md](templates/automation-pilot-verification-template.md) |
...
- 自动化检查相关评审或复盘，优先按 [docs/plans/automation-phase-acceptance-checklist.md](../plans/automation-phase-acceptance-checklist.md) 判断是否达到“可接入 CI”或“可升级为阻断”。
