...
| 自动化试运行验证输出 | [docs/reviews/templates/automation-pilot-verification-template.md](automation-pilot-verification-template.md) |
...
- 自动化阶段试运行、误报治理或“是否升级为阻断”的判断，建议使用 [docs/reviews/templates/automation-pilot-verification-template.md](automation-pilot-verification-template.md)。
