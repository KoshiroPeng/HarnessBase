...
| 我现在要做什么 | 优先阅读 |
| --- | --- |
| 调整登录、认证、租户、角色或权限规则 | [docs/design/feature-auth.md](feature-auth.md) |
| 调整 system、monitor、tool/gen、workflow、demo 页面或后端功能域 | [docs/design/feature-admin-domains.md](feature-admin-domains.md) |
| 判断当前需求是否应该成为正式功能方向 | [docs/design/backend-admin-roadmap.md](backend-admin-roadmap.md)、[docs/architecture/business-extension-baseline.md](../architecture/business-extension-baseline.md) |
| 设计落位前先核对真实代码结构 | [docs/architecture/code-map.md](../architecture/code-map.md)、[docs/architecture/boundaries.md](../architecture/boundaries.md) |
| 设计评审输出 | [docs/reviews/README.md](../reviews/README.md)、[docs/reviews/templates/README.md](../reviews/templates/README.md) |
