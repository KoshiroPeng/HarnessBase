...
本目录沉淀 HarnessBase 当前后台管理系统的功能设计入口。设计文档必须围绕当前若依微服务已有功能域展开，不能继续维护旧单体、旧行业业务或无代码事实支撑的路线。
...
| `system`、`monitor`、`tool` 功能域 | [docs/design/feature-admin-domains.md](feature-admin-domains.md) |
...
- 设计涉及接口、错误码、SQL、菜单权限或发布影响时，同步更新相关参考文档。
